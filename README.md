...
Open In Colab PyTorch Python Dataset
...
L
CE
 — Cross-Entropy	Emotion classification (primary task)	1.0
L
1
 — Anchor Loss	Groups same-emotion features: ‖E(Iₘ) − E(Iₙ)‖₁	1.0
L
adv
 — Adversarial BCE	Pushes discriminator output → 0.5 (maximum uncertainty)	0.1
Results
...
Then upload your expression_encoder.pth and fer_classifier.pth from the Releases tab and run the inference notebook.
